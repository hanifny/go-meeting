    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <!-- Page Heading -->
        ...
        <div class="row justify-content-center">
          <div class="col-md-8">
            <div class="card">
              <div class="card-header"><h3>Presensi Rapat dengan Scan QR Code</h3></div>

                <div class="card-body">
                           
                  <div class="container">
                      <!--<?php echo $_SESSION['participant']['id']; ?>-->  
                     

                    <form action="dapat_id.php" method="post" id="form">
                      <!-- get a value from qr code -->
                      <input type="hidden" name="id_user" value="<?php echo $_SESSION['participant']['id']; ?>">
                      <input type="hidden" name="id_rapat" value="<?php echo $event['id'] ?>">
                      <input type="hidden" name="y" id="y">
                    </form>
                    <h5>Petunjuk :</h5>
                    <h6>1. Scan Code QR,</h6>
                    <h6>2. Jika sudah terdengar bunyi 'tit',</h6> 
                    <h6>3. Click tombol di bawah ini!</h6>

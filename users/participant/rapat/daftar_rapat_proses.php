...
$query3 = "SELECT rapat.id, rapat.id_event, rapat.tanggal, rapat.keterangan, rapat.id_event, rapat.notulensi, events.nama
FROM rapat
...
FROM events";
  ...
  # kita mau ambil id_user dari detail presensi
  $ambil_id = mysqli_fetch_assoc($result_final);

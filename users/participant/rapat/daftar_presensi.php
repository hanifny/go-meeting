              ...
              <div class="card-header"></div>
                ...
                <div class="card-body">
                  ...
                  <div class="container">
                    ...
                    <a class="btn btn-primary" href="presensi.php"> <i class="fas fa-chevron-left"></i> Kembali </a>
                    <a class="btn btn-success" href="presensi_qr_code.php?id=<?php echo $id; ?>""> Presensi QR Code </a>
                    <br><br>
                    ...
                    <table class="table table-bordered" width="100%">
                      ...
                      <?php foreach ($daftar_hadir as $hadir) : ?>
                        <?php if ($hadir['id_rapat'] == $id && $hadir['id_user'] != 1): ?>                       
                          <tr> 
                            <td>

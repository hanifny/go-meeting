    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="row justify-content-center">
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">Edit Rapat</div>

                <div class="card-body">
                           
                  <div class="container">

                      <form method="post" action="edit_rapat_proses.php" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                        <h4>Nama</h4>
                        <p><input type="text" disabled name="nama" value="<?php echo $rapat['nama'] ?>" class="form-control form-control-user"></p>

                        <h4>Tanggal</h4>
                        <p><input type="date" name="tanggal" value="<?php echo $rapat['tanggal'] ?>" class="form-control form-control-user"></p>

                        <h4>Keterangan</h4>
                        <p><textarea name="keterangan" class="form-control form-control-user"><?php echo $rapat['keterangan'] ?></textarea></p>

              ...
              <div class="card-header">Edit Rapat</div>
                ...
                <div class="card-body">
                  ...
                  <div class="container">
                      ...
                      <form method="post" action="buat_notulensi_proses.php" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo $id; ?>">

                        <h4>Notulensi</h4>
                        <p><textarea name="notulensi" class="form-control form-control-user"><?php echo $rapat['notulensi'] ?></textarea></p>

    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="row justify-content-center">
          <div class="col-md-8">
            <div class="card">
              <div class="card-header"><h3>Jadwal Rapat</h3></div>

                <div class="card-body">
                           
                  <div class="container">

                    <center><a class="btn btn-dark" href="tambah_rapat.php"> Buat Rapat </a></center>
                    <br>
                    <table class="table table-bordered" width="100%">
                      ...
                      <tr>
                        ...
                        <td style="text-align: justify;"><?php echo $rapat['tanggal'] ?></td>
                        <td style="text-align:justify;"><?php echo $rapat['keterangan'] ?></td>
                        </td> 
                        <td>
                          <a class="btn btn-warning btn-sm" href="edit_rapat.php?id=<?php echo $rapat['id']; ?>">Edit&nbsp;</a>
                          <a class="btn btn-danger btn-sm" href="hapus_rapat.php?id=<?php echo $rapat['id']; ?>" onclick="return confirm('Apakah Anda yakin akan menghapus data?');">Hapus</a>
                          <a class="btn btn-primary btn-sm" href="notulensi.php?id=<?php echo $rapat['id']; ?>"> Notulensi </a>
                        </td>
                      </tr>
                    <?php endforeach ?>
                    </table>

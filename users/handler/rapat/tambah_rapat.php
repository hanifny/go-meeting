    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="row justify-content-center">
          <div class="col-md-8">
            <div class="card">
              <div class="card-header"><h3>Buat Rapat<h3></div>

                <div class="card-body">
                           
                  <div class="container">

                    <form method="post" action="tambah_rapat_proses.php" enctype="multipart/form-data">
          
                      <p><input type="hidden" name="id_rapat" class="form-control form-control-user" value=<?php echo $x ?>></p>

                      <h6>Event</h6>
                      <p><select name="event" class="form-control form-control-user">
                        <?php foreach ($data_event as $event) : ?>
                            <option value="<?php echo $event['id'] ?>"><?php echo $event['nama'] ?></option>
                        <?php endforeach ?>
                      </select></p>

                      <h6>Tanggal</h6>
                      <p><input type="date" name="tanggal" class="form-control form-control-user"></p>

                      <h6>Keterangan</h6>
                      <p><textarea name="keterangan" class="form-control form-control-user" ></textarea></p>

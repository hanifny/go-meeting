<?php 
  ...
  include 'daftar_handler_proses.php';
  ...
  $handler = mysqli_fetch_assoc($result);
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="tambah_handler.php">Tambah Handler</a>
            <a class="collapse-item" href="daftar_handler.php">Daftar Handler</a>
          </div>
        </div>
      </li>
              ...
              <div class="card-header">Daftar Event</div>
                ...
                <div class="card-body">
                  ...
                  <div class="container">
                      ...
                      <form method="post" action="edit_handler_proses.php" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                        <h4>Username</h4>
                        <p><input type="text" name="username" value="<?php echo $handler['username'] ?>" class="form-control form-control-user"></p>

                        <h4>Password</h4>
                        <p><input type="password" name="password" value="<?php echo $handler['password'] ?>" class="form-control form-control-user"></p>

                        <h4>Nama</h4>
                        <p><input type="text" name="nama" value="<?php echo $handler['nama'] ?>" class="form-control form-control-user"></p>

                        <h4>Jabatan</h4>
                        <p><input type="text" name="jabatan" value="<?php echo $handler['jabatan'] ?>" class="form-control form-control-user"></p>

                        <h4>No Handphone</h4>
                        <p><input type="text" name="no_hp" value="<?php echo $handler['no_hp'] ?>" class="form-control form-control-user"></p>

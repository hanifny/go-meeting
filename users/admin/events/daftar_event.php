<?php 
  ...
  include 'daftar_event_proses.php';
  $z = 0;
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="tambah_event.php">Buat Event</a>
            <a class="collapse-item" href="daftar_event.php">Daftar Event</a>
          </div>
        </div>
      </li>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="d-inline">Daftar Event</h3>
                  <a class="btn btn-success ml-3 d-inline float-right" href="tambah_event.php"> <i class="fas fa-plus-square"></i> Event </a>
                </div>
                    ...
                    <table class="table table-bordered" width="100%">
                      ...
                      <tr>
                        ...
                        <td style="text-align:justify;">
                          <?php echo $event['deskripsi'] ?><br><br>
                        ...
                        <td>
                          <ul class="pagination pagination-sm m-0 d-flex justify-content-center">
                            <li class="page-item">
                              <a class="btn btn-warning btn-sm" href="edit_event.php?id=<?php echo $event['id']; ?>"><i
                                  class="fas fa-pen-square"></i></a>
                            </li>
                            <li class="page-item ml-2">
                              <a class="btn btn-danger btn-sm" href="hapus_event.php?id=<?php echo $event['id']; ?>"

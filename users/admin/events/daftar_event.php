              ...
              <div class="card-header"> <h3>Daftar Event</h3></div>
                ...
                <div class="card-body">
                  ...
                  <div class="container">
                    ...
                    <center><a class="btn btn-dark ml-3" href="tambah_event.php"> Tambah Event </a></center>
                    ...
                    <table class="table table-bordered" width="100%">
                      ...
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-warning btn-sm" href="edit_event.php?id=<?php echo $event['id']; ?>">Edit&nbsp;</a>
                          <a class="btn btn-danger btn-sm" href="hapus_event.php?id=<?php echo $event['id']; ?>" onclick="return confirm('Apakah Anda yakin akan menghapus data?');">Hapus</a>
                        </td>
                      </tr>
                    <?php endforeach ?>
                    </table>

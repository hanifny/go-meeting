    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="row justify-content-center">
          <div class="col-md-8">
            <div class="card">
              <div class="card-header"><h3>Tambah Event<h3></div>

                <div class="card-body">
                           
                  <div class="container">

                    <form method="post" action="tambah_event_proses.php" enctype="multipart/form-data">
                      <h6>Nama Event</h6>
                      <p><input type="text" name="nama" class="form-control form-control-user"></p>

                      <h6>Deskripsi</h6>
                      <p><textarea class="form-control form-control-user" name="deskripsi"></textarea></p>

                      <h6>Tanggal Pelaksanaan</h6>
                      <input class="form-control form-control-user" type="date" name="tanggal"><br>

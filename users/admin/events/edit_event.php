              ...
              <div class="card-header">Daftar Event</div>
                ...
                <div class="card-body">
                  ...
                  <div class="container">
                      ...
                      <form method="post" action="edit_event_proses.php" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                        <h4>Nama</h4>
                        <p><input type="text" name="nama" value="<?php echo $event['nama'] ?>" class="form-control form-control-user"></p>

                        <h4>Deskripsi</h4>
                        <p><textarea name="deskripsi" class="form-control form-control-user"><?php echo $event['deskripsi'] ?></textarea></p>

                        <h4>Tanggal</h4>
                        <p><input type="date" name="tanggal" value="<?php echo $event['tanggal'] ?>" class="form-control form-control-user"></p>

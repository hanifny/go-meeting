      ...
      <div id="content">
        ...
        <div class="row justify-content-center">
          <div class="col-md-8">
            <div class="card">
              <!-- Tambah Handler -->
              <div class="card-header"><h3>Tambah Peserta<h3></div>

                <div class="card-body">
                           
                  <div class="container">

                    <form method="post" action="tambah_peserta_proses.php" enctype="multipart/form-data">
                      <h6>Username</h6>
                      <p><input type="text" name="username" class="form-control form-control-user"></p>

                      <h6>Password</h6>
                      <p><input type="password" name="password" class="form-control form-control-user"></p>

                      <h6>Nama</h6>
                      <p><input type="text" name="nama" class="form-control form-control-user"></p>

                      <h6>Jabatan</h6>
                      <p><input type="text" name="jabatan" class="form-control form-control-user"></p>

                      <h6>No Handphone</h6>
                      <p><input type="text" name="no_hp" class="form-control form-control-user"></p>

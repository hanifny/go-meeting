              ...
              <div class="card-header"><h3>Daftar Peserta</h3></div>
                ...
                <div class="card-body">
                  ...
                  <div class="container">
                    ...
                    <center><a class="btn btn-dark" href="tambah_peserta.php"> Tambah Peserta </a></center>
                    ...
                    <table class="table table-bordered" width="100%">
                      ...
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-warning btn-sm" href="edit_peserta.php?id=<?php echo $peserta['id']; ?>">Edit&nbsp;</a>
                          <a class="btn btn-danger btn-sm" href="hapus_peserta.php?id=<?php echo $peserta['id']; ?>" onclick="return confirm('Apakah Anda yakin akan menghapus data?');">Hapus</a>
                        </td>
                        <?php endif ?>
                      </tr>
                    <?php endforeach ?>

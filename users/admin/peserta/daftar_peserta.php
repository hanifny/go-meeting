            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <a class="btn btn-success d-inline float-right" href="tambah_peserta.php"> <i
                      class="fas fa-plus-square"></i> Peserta </a>
                </div>
                          ...
                          <ul class="pagination pagination-sm m-0 d-flex justify-content-center">
                            <li class="page-item">
                              <a class="btn btn-warning btn-sm"
                                href="edit_peserta.php?id=<?php echo $peserta['id']; ?>"><i
                                  class="fas fa-pen-square"></i></a>
                            </li>
                            <li class="page-item">
                              <a class="btn btn-danger btn-sm ml-2" href="hapus_peserta.php?id=<?php echo $peserta['id']; ?>"

<?php 
  ...
  include 'daftar_peserta_proses.php';
              ...
              <div class="card-header">Daftar Event</div>
                ...
                <div class="card-body">
                  ...
                  <div class="container">
                      ...
                      <form method="post" action="edit_peserta_proses.php" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                        <h4>Username</h4>
                        <p><input type="text" name="username" value="<?php echo $peserta['username'] ?>" class="form-control form-control-user"></p>

                        <h4>Password</h4>
                        <p><input type="password" name="password" value="<?php echo $peserta['password'] ?>" class="form-control form-control-user"></p>

                        <h4>Nama</h4>
                        <p><input type="text" name="nama" value="<?php echo $peserta['nama'] ?>" class="form-control form-control-user"></p>

                        <h4>Jabatan</h4>
                        <p><input type="text" name="jabatan" value="<?php echo $peserta['jabatan'] ?>" class="form-control form-control-user"></p>

                        <h4>No Handphone</h4>
                        <p><input type="text" name="no_hp" value="<?php echo $peserta['no_hp'] ?>" class="form-control form-control-user"></p>

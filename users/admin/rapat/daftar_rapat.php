...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePagesq" aria-expanded="true"
          aria-controls="collapsePagesq">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <span
                  class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_SESSION['admin']['nama']; ?></span>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="d-inline">Jadwal Rapat</h3>
                  <a class="btn btn-success ml-3 d-inline float-right" href="tambah_rapat.php"> <i class="fas fa-plus-square"></i> Rapat </a>
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="container">
                    ...
                    <table class="table table-bordered" width="100%">
                      ...
                      <?php foreach ($daftar_rapat as $rapat) : ?>
                      <tr align="center">
                      <tr>
                        <td style="text-align: center"><?php $z++; echo $z ?></td>
                        <td><?php echo $rapat['nama'] ?></td>
                        <td style="text-align: center;"><?php echo $rapat['tanggal'] ?></td>
                        <td style="text-align: center;"><?php echo $rapat['keterangan'] ?></td>
                        </td>
                        <td>
                          <ul class="pagination pagination-sm m-0 d-flex justify-content-center">
                            <li class="page-item">
                              <a class="btn btn-warning btn-sm" href="edit_rapat.php?id=<?php echo $rapat['id']; ?>"><i
                                  class="fas fa-pen-square"></i></a>
                            </li>
                            <li class="page-item ml-2">
                              <a class="btn btn-danger btn-sm" href="hapus_rapat.php?id=<?php echo $rapat['id']; ?>"
                                onclick="return confirm('Apakah Anda yakin akan menghapus data?');"><i
                                  class="fas fa-minus-square"></i></a>
                            </li>
                            <li class="page-item ml-2">
                              <a class="btn btn-primary btn-sm" href="notulensi.php?id=<?php echo $rapat['id']; ?>">

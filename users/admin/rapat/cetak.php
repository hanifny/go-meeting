...
$pdf->Cell(0,10, 'HIMPUNAN MAHASISWA TEKNIK INFORMATIKA', '0', '1', 'C', false);
...
$pdf->Cell(0,5, 'DAFTAR PRESENSI RAPAT', '0', '1', 'C', false);
$pdf->Ln(3);
...
foreach ($hasilpresensi as $satupresensi) {
    ...
    $pdf->Cell(70, 6, $hasilUser["nama"], '1', '0', 'L', false);
    $pdf->Cell(60, 6, $hasilUser["jabatan"], '1', '0', 'L', false);
